    ...
    <div className='flex flex-col min-h-screen '>
        <div className='w-screen h-screen flex flex-col items-center bg-[url("/Assets/foods/background-food-page.png")] bg-cover bg-no-repeat bg-center bg-fixed'>
            ...
            <div className='w-screen sm:w-[70vw] h-[90vh] flex justify-center items-center px-10 pb-[7rem] flex-col'>
                <h1 className='text-white text-5xl lg:text-[72px] italic text-center'>Foods</h1>
                <p className='text-white text-[12px] text-center mt-5 lg:w-[50vw] lg:text-[16px]'>The food in Jogja is a tantalizing blend of rich flavors and unique ingredients that create a culinary experience like no other.</p>
            </div>
        </div>
        <div className='bg-white shadow-lg border-spacing-3 px-5 '>
            <div className='flex flex-col md:flex-row md:px-[40px] md:justify-between lg:px-[80px] xl:px-[140px]'>
                <div className='flex flex-col justify-center md:items-start w-full py-8'>
                    <h1 className=' mt-5 mb-4 text-4xl font-medium tracking-tight leading-none md:text-5x1 xl:text-6x1  font-lora'>Foods</h1> 
                        <div className="flex ">
                            Explore foods
                ...
                <div className='flex w-full md:w-[400px] lg:w-[500px] xl:w-[600px]  text-[12px] lg:text-[16px] md:items-center md:text-start lg:pt-6'>
                    <p>The food in Jogja is simply extraordinary, boasting a delightful blend of flavors that will tantalize your taste buds and leave you craving for more.</p>
                </div>
            </div>
