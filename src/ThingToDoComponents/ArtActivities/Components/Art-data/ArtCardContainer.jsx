    ...
    <div className="w-screen h-fil bg-white font-Poppins ">
        <div className='grid md:grid-cols-2 max-w-[1240px] px-10 lg:px-[80px]'>
            <div className='flex flex-col justify-center md:items-start w-full py-8'>
                <h1 className=' mt-5 mb-4 text-4xl font-medium tracking-tight leading-none md:text-5x1 xl:text-6x1  font-lora'>Art Activity</h1> 
        ...
        <div className="flex flex-col justify-center items-center w-full bg-background1 px-5 mt-5">
          ...
          <div className='flex items-center justify-center mt-8 mb-8'>
              <button type='button' className='bg-button font-semibold py-3 px-5 rounded-lg  hover:brightness-110 hover:text-button drop-shadow-lg'>
        ...
        <div className='grid md:grid-cols-2 max-w-[1240px]  px-10 lg:px-[80px] gap-5'>
            <div className='flex  flex-col justify-center md:items-start w-full py-8'>
                <h1 className=' mt-5  mb-4 text-4xl font-medium tracking-tight leading-none md:text-5x1 xl:text-6x1 font-lora'>Cultures are everywhere</h1> 
                <a href="#" className="flex ">
                    Explore more
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 ml-2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
