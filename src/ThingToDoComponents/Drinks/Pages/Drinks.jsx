    ...
    <div className='flex flex-col min-h-screen '>
        <div className='w-screen h-screen flex flex-col items-center bg-[url("/Assets/drinks/background-drinks-page.jpg")] bg-cover bg-no-repeat bg-center bg-fixed'>
            ...
            <div className='w-screen sm:w-[70vw] h-[90vh] flex justify-center items-center px-10 pb-[7rem] flex-col'>
                <h1 className='text-white text-5xl lg:text-[72px] italic text-center'>Drinks</h1>
                <p className='text-white text-[12px] text-center mt-5 lg:w-[50vw] lg:text-[16px]'>Jogjakarta's drinks culinary scene is a vibrant tapestry of flavors and traditions, reflecting the rich cultural heritage of this Indonesian city.</p>
            </div>
        </div>
        <div className='bg-white shadow-lg border-spacing-3 px-5 '>
            <div className='flex flex-col md:flex-row md:px-[40px] md:justify-between lg:px-[80px] xl:px-[140px]'>
                <div className='flex flex-col justify-center md:items-start w-full py-8'>
                    <h1 className=' mt-5 mb-4 text-4xl font-medium tracking-tight leading-none md:text-5x1 xl:text-6x1  font-lora'>Drinks</h1> 
                        <div className="flex ">
                            Explore drinks
                ...
                <div className='flex w-full md:w-[400px] lg:w-[500px] xl:w-[600px]  text-[12px] lg:text-[16px] md:items-center md:text-start lg:pt-6'>
                    <p>These unique and tantalizing beverages encapsulate the essence of Jogjakarta's culinary creativity, offering a sensory journey through the diverse and delightful flavors of this Indonesian city.</p>
                </div>
            </div>
